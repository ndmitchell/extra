...
module Extra {-# DEPRECATED "This module is provided as documentation of all new functions, you should import the more specific modules directly." #-} (
    ...
    Partial, retry, retryBool, errorWithoutStackTrace, showException, stringException, errorIO, ignore, catch_, handle_, try_, catchJust_, handleJust_, tryJust_, catchBool, handleBool, tryBool, withException, displayExceptionType,
    -- * Control.Monad.Extra
    ...
    -- | Extra functions available in @"Control.Monad.Except.Extra"@.
    tryError, withError, handleError,
    -- * Data.Either.Extra
